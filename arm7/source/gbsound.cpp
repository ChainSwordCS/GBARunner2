...
static void updateChannelFreq(int channel)
{
	switch (channel)
	{
		case 0:
			...
			REG_SOUND[GB_CHANNEL_1_HW_L].TMR = -16 * (2048 - sChannelFreq[0]);
			REG_SOUND[GB_CHANNEL_1_HW_R].TMR = -16 * (2048 - sChannelFreq[0]);
#else
		...
		case 1:
#ifdef USE_GBA_ADJUSTED_SYNC
			REG_SOUND[GB_CHANNEL_2_HW_L].TMR = -16 * (2048 - sChannelFreq[1]);
			REG_SOUND[GB_CHANNEL_2_HW_R].TMR = -16 * (2048 - sChannelFreq[1]);
#else
		...
		{
#ifdef USE_GBA_ADJUSTED_SYNC
			REG_SOUND[GB_CHANNEL_3_HW_L_0].TMR = -8 * (2048 - sChannelFreq[2]);
			REG_SOUND[GB_CHANNEL_3_HW_R_0].TMR = -8 * (2048 - sChannelFreq[2]);
			REG_SOUND[GB_CHANNEL_3_HW_L_1].TMR = -8 * (2048 - sChannelFreq[2]);
			REG_SOUND[GB_CHANNEL_3_HW_R_1].TMR = -8 * (2048 - sChannelFreq[2]);
#else
...
#ifdef USE_GBA_ADJUSTED_SYNC
			REG_SOUND[GB_CHANNEL_4_HW_L].TMR = -4 * div;
			REG_SOUND[GB_CHANNEL_4_HW_R].TMR = -4 * div;
#else
